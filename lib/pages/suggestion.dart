...
class _SuggestionState extends State<Suggestion> {
  ...
  Widget build(BuildContext context) {
    ...
    if_low = [
      ...
      {(args['bangla'] ? 'মাছের দৈর্ঘ্য' : 'Fish Length'):(args['bangla'] ? 'মাছের বৃদ্ধি বাড়ানোর জন্য তাদের ইকোফিসকাল এবং ইকোগ্রোথ-প্রমোটার খাওয়ান। প্রতি কেজি 5 গ্রাম খাওয়ান।' : 'To increase fish growth feed them ecofiscal and ecogrowth-promoter. Feed 5gm of it per kg.'),
